...
def load_model(trainer, model_path):
...
def test(trainer, test_dataloader, patch_size=128):
    ...
    for i, batch in enumerate(test_dataloader):
        ...
        save_path = f'results/denormalized_impedance_1_{i}.mat'
        savemat(save_path, {'denormalized_impedance_1': predicted_impedance})
        print(f"denormalized_impedance_1 saved to {save_path}")

        save_with_colormap(predicted_impedance, f'results/predicted_impedance_{i}.png', nrow=1)
        save_with_colormap(labels, f'results/true_impedance_{i}.png', nrow=1)
        print(f"predicted_impedance shape: {predicted_impedance.shape}")
...
if __name__ == '__main__':
    ...
    trainer = Trainer(
        ...
        load_path='./PGDM/results_wave_impedance/model.pt',
        dataset='test',
        save_and_sample_every=100
    )

    load_model(trainer, './PGDM/results_wave_impedance/model.pt')
